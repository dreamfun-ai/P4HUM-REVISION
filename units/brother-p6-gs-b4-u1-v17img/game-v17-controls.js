...
let zoomMode = localStorage.getItem('brother_p6_gs_b4_u1_zoom') || 'fit';
let pdfHeightMode = localStorage.getItem('brother_p6_gs_b4_u1_pdf_height') || 'medium';
...
function key(){ return 'progress_brother_p6_gs_b4_u1_' + user; }
...
function setZoom(z){ zoomMode=z; localStorage.setItem('brother_p6_gs_b4_u1_zoom',z); applyZoom(); }
function setPdfHeight(h){ pdfHeightMode=h; localStorage.setItem('brother_p6_gs_b4_u1_pdf_height',h); applyZoom(); }
