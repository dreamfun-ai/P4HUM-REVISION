...
let zoomMode = localStorage.getItem('brother_p6_gs_b6_u2_zoom') || 'fit';
let pdfHeightMode = localStorage.getItem('brother_p6_gs_b6_u2_pdf_height') || 'medium';
...
function key(){ return 'progress_brother_p6_gs_b6_u2_' + user; }
...
function setZoom(z){ zoomMode=z; localStorage.setItem('brother_p6_gs_b6_u2_zoom',z); applyZoom(); }
function setPdfHeight(h){ pdfHeightMode=h; localStorage.setItem('brother_p6_gs_b6_u2_pdf_height',h); applyZoom(); }
