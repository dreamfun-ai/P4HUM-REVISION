...
let zoomMode = localStorage.getItem('sister_p4_hum_u7_zoom') || 'fit';
let pdfHeightMode = localStorage.getItem('sister_p4_hum_u7_pdf_height') || 'medium';
...
function key(){ return 'progress_sister_p4_hum_u7_' + user; }
...
function setZoom(z){ zoomMode=z; localStorage.setItem('sister_p4_hum_u7_zoom',z); applyZoom(); }
function setPdfHeight(h){ pdfHeightMode=h; localStorage.setItem('sister_p4_hum_u7_pdf_height',h); applyZoom(); }
