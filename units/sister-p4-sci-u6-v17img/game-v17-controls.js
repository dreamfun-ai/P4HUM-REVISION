...
let zoomMode = localStorage.getItem('sister_p4_sci_u6_zoom') || 'fit';
let pdfHeightMode = localStorage.getItem('sister_p4_sci_u6_pdf_height') || 'medium';
...
function key(){ return 'progress_sister_p4_sci_u6_' + user; }
...
function setZoom(z){ zoomMode=z; localStorage.setItem('sister_p4_sci_u6_zoom',z); applyZoom(); }
function setPdfHeight(h){ pdfHeightMode=h; localStorage.setItem('sister_p4_sci_u6_pdf_height',h); applyZoom(); }
